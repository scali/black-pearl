			...
			<div class="right_block">
				...
				<div class="content_price">
					{if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
						...
						<span class="price" style="display: inline; font-size:15px">
				...
				{else}
				<div class="content_price"><span class="price" style="display: inline; font-size:15px"><a href="/magasin/contactez-nous?message=Ref:[{$product.name|escape:'htmlall':'UTF-8'}]&id_contact=2" style="color: #D4AA5D;">Nous contacter</a></span></div>
				{/if}
				{if isset($product.online_only) && $product.online_only}<span class="online_only">{l s='Online only!'}</span>{/if}
				
				{else}
				<div class="content_price"><span class="price" style="display: inline; font-size:15px"><a href="/magasin/contactez-nous?message=Ref:[{$product.name|escape:'htmlall':'UTF-8'}]&id_contact=2" style="color: #D4AA5D;">Nous contacter</a></span></div>
				{* end of show price condition*}
				{/if}
