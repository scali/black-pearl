...
<div id="editorial_block_center" class="editorial_block">
	...
	<div itemscope itemtype="http://schema.org/Store" itemid="lbdj_store">
	{if $editorial->body_paragraph}<div class="rte" itemprop="description">{$editorial->body_paragraph|stripslashes}</div>
	{elseif $editorial->body_paragraph}<div class="rte" itemprop="description">{$editorial->body_paragraph|stripslashes}</div>{/if}
	</div>
</div>
<!-- /Module Editorial -->
